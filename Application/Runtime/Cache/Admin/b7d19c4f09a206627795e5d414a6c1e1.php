...
<!-----主內容------>
<div class="container">
    <div class="tabTitle"><?php echo ($parent["title"]); ?> > <span class="conTitle">更新資料</span></div>
    <div class="Main">
        <form id="loadupdata"  action="<?php echo u('Relate/onupdateexcel');?>" method="post" enctype="multipart/form-data">
            <font color="red">在課程索引將課程匯出即可，清單有使用教學</font>
            <br>
            <input type="file" name="excel" />
            <input type="text" name="title" value="" placeholder="紀錄文字" />
            <input type="button" class="sub" value="更新" />
            <!--<input type="submit" class="sub" value="更新" />-->
        </form>
        <br>
...
$('.allCheckedMenu').click(function(evt){
    ...
    $('.sub').click(function() {
        ...
        $("#loadupdata").ajaxSubmit({
            //dataType:'script',
            type: 'post',
            url: "<?php echo u('Relate/onupdateexcel');?>",

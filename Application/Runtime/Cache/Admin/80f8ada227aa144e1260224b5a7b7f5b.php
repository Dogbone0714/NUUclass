...
<!-----主內容------>
<div class="container">
	<div class="tabTitle">文章編輯 > <span class="conTitle"><?php echo ($vo["title"]); ?></span></div>                           
    <div class="Main">
		<!-- 按鈕 start -->
		<!-- 按鈕 end -->
		
		<form method="post" action="<?php echo U('About/doModify');?>" enctype="multipart/form-data" id="mainFrom">
			<div class="tabB">
				<table border="0" cellpadding="0" cellspacing="0" >
					...
					<tr>
						<td>
							<input type="hidden" name="status_description" id="descriptions" value="<?php echo (htmlspecialchars($vo["status_description"])); ?>">
						</td>
					</tr>
				<tr>
					<td colspan="2">

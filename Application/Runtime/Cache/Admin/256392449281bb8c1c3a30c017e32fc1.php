...
<div class="container">
    ...
    <div class="Main">
    每學期更換課表時使用，會將使用者資料還原
    <br>
        <font color="red">*此功能會將使用者選的選課資料清空，請警慎使用</font>
        <form action="<?php echo u('Relate/onreuser');?>" id="loadupdata" method="post" enctype="multipart/form-data">
            <input type="submit" value="重整" />
        </form>
